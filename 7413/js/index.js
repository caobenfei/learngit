        ...
        afterLoad: function(anchorLink,index){
            ...
            if(index==2){
                ...
                $("#about_info").animate({width:"800px",marginTop:"0",marginBottom:"0"},700,'easeOutElastic',function(){
                    $("#about_info p").eq(0).animate({bottom:"0"},400,function(){
                        $("#about_info p").eq(1).animate({bottom:"0"},400,function(){
                            $("#about_info p").eq(2).animate({bottom:"0"},400,function(){
                                $("#about_info p").eq(3).animate({bottom:"0"},400);
                            });
                        });
                    });
                });
